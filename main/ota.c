...
void set_ota_url(char *ota_url_nt)
{
    strcpy(ota_url, ota_url_nt);
}
...
void simple_ota_example_task(void *pvParameter)
{
    ...
    ESP_LOGI(TAG_OTA, "Bind interface name is %s", ifr.ifr_name);

#endif
    esp_http_client_config_t config = {
        .url = ota_url, // CONFIG_EXAMPLE_FIRMWARE_UPGRADE_URL,
    ...
    ESP_LOGI(TAG_OTA, "OTA url is %s", ota_url);
...
void start_ota(char *url, int length)
{
    // Initialize NVS.
